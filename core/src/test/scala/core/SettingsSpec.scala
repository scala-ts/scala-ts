...
final class SettingsSpec extends org.specs2.mutable.Specification {
  ...
  val fullConf = """{"discriminator":"_type","emitCodecs":true,"fieldMapper":"Identity","optionToNullable":false,"optionToUndefined":true,"prependEnclosingClassNames":true,"prependIPrefix":true,"typescriptIndent":"\t","typescriptLineSeparator":";"}"""
